...
-- Create new enum without Comedy
CREATE TYPE super_genre_new AS ENUM (
  'Bass', 'Blues', 'Books & Spoken', 'Country', 
...
UPDATE spotify_genre_map_base SET super_genre_new = 
  CASE 
    WHEN super_genre = 'Comedy' THEN 'Books & Spoken'::super_genre_new
...
-- Migrate spotify_genre_map_overrides
